...
module rather than copying its logic; ``tests/loop_harness/test_auto_confirm_calibration.py``
is the calibration probe that catches regressions in either direction.
