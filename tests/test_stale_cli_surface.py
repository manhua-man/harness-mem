...
SCAN_TARGETS: tuple[str, ...] = (
    ...
    "plugins/harness-mem/commands/hm/mark.md",
    "plugins/harness-mem/commands/hm/prune.md",
    "plugins/harness-mem/commands/hm/review-kb.md",
    "plugins/harness-mem/commands/hm/prune-kb.md",
    "plugins/harness-mem/commands/hm/verify-entry.md",
