...
def test_roadmap_status_short_summary_mentions_full_completed_range() -> None:
    ...
    assert "v2.2 用户入口闭环（runtime / contract 已落地，且已有 Codex + generic MCP 两条 non-Claude smoke entry，Cursor hook install 与真实 agent run-log 证据已出现，但手工 full matrix gate 未闭）" in roadmap_status
