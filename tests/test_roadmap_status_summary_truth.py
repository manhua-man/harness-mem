...
def test_roadmap_status_short_summary_mentions_full_completed_range() -> None:
    ...
    assert "从 v1.5 baseline 到 v3.4.4 Runtime Health, Cost Discipline, and Regression Gates，主实现路线已经按一个版本一个文档重切并连续收口。" in roadmap_status
    ...
    assert "current/history/as_of temporal query / supersede timeline / abstention，以及 v3.4.x 的" in roadmap_status
