---
name: hm-search-all
description: Run the harness-mem search-all daily action when the user invokes hm-search-all.
---
...
1. **确认当前项目**：从 slash 参数或 MCP `get_project_status(project_root=<当前工作区>, host_client="codex")` 的 active project
