...
- [x] 1.1 Update v2.4 roadmap wording from `notify_only` / `embedded_llm` to the shipped `distill.mode` values.
- [x] 1.2 Update release/status/roadmap writeback to reflect v2.9.12.

## 2. Guardrail

- [x] 2.1 Extend the focused config-truth regression test to cover `distill.mode`.
