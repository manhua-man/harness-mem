...
- [x] 1.1 Update the top baseline summary in `docs/roadmap-status.md` so it summarizes the completed line from `v1.5` through `v2.9`.
- [x] 1.2 Update release writeback for `v2.9.38`.

## 2. Guardrail

- [x] 2.1 Extend the focused baseline regression test so it rejects drifting back to the older `v2.5` starting point.
