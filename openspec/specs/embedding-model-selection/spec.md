...
Defines local embedding model selection for persistent vector retrieval. Model
selection is configured locally and consumed by MCP/read API search paths.
## Requirements
...
- **WHEN** `search_memory` runs with `mode="hybrid"`
