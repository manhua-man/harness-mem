...
Defines the offline embedding model shootout used to decide whether to change
the default local embedding model. This is a developer benchmark tool, not a
daily user memory workflow.
## Requirements
