...
Cursor Canvas 交互面板源码，与 `docs/how-it-works-visual-guide.md` 配套使用。
...
在 Cursor 中直接打开本目录下的 `.canvas.tsx` 文件，可渲染为侧边交互面板。

若 Cursor 工作区根目录就是 `harness-mem/`，从文件树点开即可；若侧边未自动弹出，双击文件也会渲染。
