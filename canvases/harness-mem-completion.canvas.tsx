...
const CAPABILITIES = [
  ...
  { area: "Default Change Gate", status: "Gate 已过", note: "ready=true；实际 default kernel cutover 在 v5.1-v5.2 完成" },
];
    ...
    <Stack gap={20} style={{ padding: 20, maxWidth: 960, margin: "0 auto" }}>
      ...
      <Stack gap={8}>
        ...
        <Grid columns={2} gap={8}>
          <Text>
            <Text weight="semibold">harness_mem/</Text> — Python 运行时、MCP、storage、search
          </Text>
          <Text>
            <Text weight="semibold">benchmark-suite/</Text> — benchmark 集合与 release snapshot
          </Text>
          <Text>
            <Text weight="semibold">docs/</Text> — 产品文档与图解
          </Text>
          <Text>
            <Text weight="semibold">plugins/harness-mem/</Text> — Slash、安装、IDE 集成
          </Text>
        </Grid>
        <Text tone="tertiary" size="small">
