...
**Reject：** Letta agent/server runtime、云 archival 语义、block filesystem 和把可编辑 prompt block 升格为 durable truth。它们会破坏本项目“本机保存、一份当前记忆、由 canonical spec 固定公开 MCP surface”的边界；`0.9.28` 的公开 surface 为 20 个工具。
