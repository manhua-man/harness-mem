...
>
> 配合 [`roadmap-v16x.md`](./roadmap-v16x.md) 与 [`roadmap-v23.md`](./roadmap-v23.md) 阅读：v1.7 的职责是让 memory runtime 长出"时间感"，不是提前做 Memory Metabolism，也不是提前做 procedural memory。
