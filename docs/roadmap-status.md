...
| `harness_mem/__init__.py` | `3.3.2` |
| `CHANGELOG.md` | 已有 `3.3.2` 段；`Unreleased` 当前为空 |

## 产品基线

当前收口基线是 v3.3.2：v1.5 baseline、v1.6 persistent vectors / bucket budget、
...
当前版本 v3.3.2 已发布 Temporal Query and Supersede Explainability：MCP
