...
| 来源 | 值 |
|---|---|
| `pyproject.toml` | `2.9.18` |
| `harness_mem/__init__.py` | `2.9.18` |
| `CHANGELOG.md` | 已有 `2.9.18` 段；`Unreleased` 当前为空 |

当前收口基线是 v2.9.18：v2.5.0–v2.5.2 的 context assembly / wake renderer /
...
> **v2.9.18 发版状态（2026-06-03）**：版本号已 bump 到 `2.9.18`。v2.9 在保持
...
> 手工拼 `get_project_profile` / `list_candidates` / `timeline` 才给下一步建议。
