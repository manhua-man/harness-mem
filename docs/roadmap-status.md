...
| 来源 | 值 |
|---|---|
| `pyproject.toml` | `2.9.17` |
| `harness_mem/__init__.py` | `2.9.17` |
| `CHANGELOG.md` | 已有 `2.9.17` 段；`Unreleased` 当前为空 |

当前收口基线是 v2.9.17：v2.5.0–v2.5.2 的 context assembly / wake renderer /
...
> **v2.9.17 发版状态（2026-06-03）**：版本号已 bump 到 `2.9.17`。v2.9 在保持
